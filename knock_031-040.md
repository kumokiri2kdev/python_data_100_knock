...
uselog_month = uselog.groupby(
  by=['usemonth', 'customer_id'],as_index=False
).count()
```
...
```python
year_months = list(uselog_month['usemonth'])
...
...         ...          ...         ...      ...      ...      ...      ...      ...      ...
18305     False        False       False    False     True     True     True     True     True
18306     False        False       False    False    False    False    False    False    False
18307     False        False       False    False    False    False    False    False    False
18308     False        False       False    False    False    False    False    False    False
18309     False        False       False    False    False    False    False    False    False
...
```
'predict_data' に 'usemonth' を 'target_date' を datetime で追加せよ。
...
for _, row in predict_data.iterrows():
  delta = relativedelta(row['target_date'], row['start_date'])
...
1       201810    AS009373           5      6.0      6.0      7.0      4.0      4.0      3.0 2015-11-01  2018-10-01      23
2       201810    AS015315           4      7.0      3.0      6.0      3.0      3.0      6.0 2015-07-01  2018-10-01      23
3       201810    AS015739           5      6.0      5.0      8.0      6.0      5.0      7.0 2017-06-01  2018-10-01      23
4       201810    AS019860           7      5.0      7.0      4.0      6.0      8.0      6.0 2017-10-01  2018-10-01      23
...        ...         ...         ...      ...      ...      ...      ...      ...      ...        ...         ...     ...
15108   201903    TS995299           3      3.0      5.0      4.0      5.0      4.0      5.0 2015-09-01  2019-03-01      23
15109   201903    TS998593           8      7.0      8.0      7.0      9.0      9.0      9.0 2018-09-01  2019-03-01      23
15110   201903    TS999079           3      2.0      6.0      9.0      6.0      6.0      4.0 2016-06-01  2019-03-01      23
15111   201903    TS999231           6      6.0      3.0      8.0      5.0      5.0      4.0 2017-03-01  2019-03-01      23
...
'X' と 'y' をそれぞれ、訓練用データとテスト要データに振り分けよ。
...
```
線形学習モデル似て、X_train, y_train を使用して学習せよ。
``` python
...
```
array([0.33743659, 0.18947139, 0.18865268, 0.16094624, 0.0673015 ,
       0.06116984])
```
